...
public class ArticlesServlet extends HttpServlet {
        ...
        PagedList<Article> articles = new QArticle()
            .setFirstRow(offset)
                .setMaxRows(articlesPerPage)
                    .orderBy().id.asc()
                .findPagedList();
        List<Article> articleList = articles.getList();
    ...
    private void showArticle(HttpServletRequest request,
        ...
        // BEGIN
        Article article = new QArticle().findList().stream()
    ...
    private void createArticle(HttpServletRequest request,
        ...
        // BEGIN
        Category category = new QCategory().findList().stream()
            .filter(val -> val.getId() == Integer.parseInt(categoryId))
            .findAny()
            .orElse(null);
