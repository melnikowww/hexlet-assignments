...
public class AppTest {
    ...
    // BEGIN
    @ParameterizedTest
    @ValueSource(strings = {"John", "Jack", "Jassica"})
    void testGetPeople(String name) throws Exception {
        MockHttpServletResponse response = mockMvc
            .perform(get("/people"))
            .andReturn()
            .getResponse();
    ...
    @ParameterizedTest
    @ValueSource(strings = {"John", "However", "john@gmail.com"})
    void testPatchPerson(String personData) throws Exception {
        String email = "john@gmail.com";
        var id = TestUtils.getUserIdByEmail(mockMvc, email);

        PersonDto personDto = new PersonDto();
        personDto.setFirstName("John");
        personDto.setLastName("However");
        ...
        assertThat(response.getContentAsString()).contains(personData);
    }

    @ParameterizedTest
    @ValueSource(strings = {"John", "However", "john@gmail.com"})
    public void testDeletePerson(String personData) throws Exception {
        String email = "john@gmail.com";
        var id = TestUtils.getUserIdByEmail(mockMvc, email);

        mockMvc
            .perform(delete("/people/{id}", id))
            .andExpect(status().isOk());
        ...
        assertThat(response.getContentAsString()).doesNotContain(personData);
    }
    // END
}
